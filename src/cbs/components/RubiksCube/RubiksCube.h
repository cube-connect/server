...
constexpr float FACE_ROTATION_SPEED = 2.5f;
constexpr float CUBE_ROTATION_SPEED = 2.5f;
...
class RubiksCube : public Component {
  ...
  public:
    enum class ERotation { CLOCKWISE = -1, COUNTER_CLOCKWISE = 1 };

    enum class EFace { FRONT = 'F', BACK = 'B', UP = 'U', DOWN = 'D', LEFT = 'L', RIGHT = 'R' };

    enum class EDirection { UP = 'Y', RIGHT = 'X', FRONT = 'Z' };
