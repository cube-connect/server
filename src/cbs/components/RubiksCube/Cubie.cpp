...
Cubie::Cubie(const glm::mat4 *parent, glm::vec3 position, EColor front, EColor left, EColor right, EColor top,
             EColor bottom)
    : Drawable(ShaderProgram::Type::PURE_COLOR), m_FrontFace(front), m_LeftFace(left), m_RightFace(right),
      m_TopFace(top), m_BottomFace(bottom), m_ParentModel(parent), m_Position(position), m_Rotation(glm::vec3(0.0f)),
      m_Model(1.0f) {
...
glm::mat4 Cubie::GetModelMatrixToDrawCubie() const {
