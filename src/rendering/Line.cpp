...
Line::Line(glm::vec3 start, glm::vec3 end, glm::vec3 color)
    : Drawable(ShaderProgram::Type::PURE_COLOR), m_Start(start), m_End(end), m_Color(color) {
    SetupLine();
}

Line::Line(const Line &other)
    : Drawable(ShaderProgram::Type::PURE_COLOR), m_Start(other.m_Start), m_End(other.m_End), m_Color(other.m_Color) {
    SetupLine();
}
