...
conan_package_library_targets("${kuba-zip_LIBS_RELEASE}"    # libraries
                              ...
                              "${kuba-zip_BIN_DIRS_RELEASE}" # package_bindir
                              "${kuba-zip_LIBRARY_TYPE_RELEASE}"
                              "${kuba-zip_IS_HOST_WINDOWS_RELEASE}"
                              kuba-zip_DEPS_TARGET
                              kuba-zip_LIBRARIES_TARGETS  # out_libraries_targets
                              "_RELEASE"
                              "kuba-zip"    # package_name
                              "${kuba-zip_NO_SONAME_MODE_RELEASE}")  # soname
...
########## GLOBAL TARGET PROPERTIES Release ########################################
    ...
    set_property(TARGET zip::zip
                 ...
                 $<$<CONFIG:Release>:${kuba-zip_LINKER_FLAGS_RELEASE}>)
    set_property(TARGET zip::zip
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Release>:${kuba-zip_INCLUDE_DIRS_RELEASE}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET zip::zip
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Release>:${kuba-zip_LIB_DIRS_RELEASE}>)
    set_property(TARGET zip::zip
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Release>:${kuba-zip_COMPILE_DEFINITIONS_RELEASE}>)
    set_property(TARGET zip::zip
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Release>:${kuba-zip_COMPILE_OPTIONS_RELEASE}>)
